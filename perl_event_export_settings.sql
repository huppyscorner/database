...
CREATE TABLE `perl_event_export_settings`  (
  ...
  `event_description` varchar(150) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `export_qglobals` smallint(11) NULL DEFAULT 0,
  `export_mob` smallint(11) NULL DEFAULT 0,
  `export_zone` smallint(11) NULL DEFAULT 0,
  `export_item` smallint(11) NULL DEFAULT 0,
  `export_event` smallint(11) NULL DEFAULT 0,
...
INSERT INTO `perl_event_export_settings` VALUES (11, 'EVENT_TIMER', 1, 1, 1, 0, 1);
...
INSERT INTO `perl_event_export_settings` VALUES (35, 'EVENT_SCALE_CALC', 1, 1, 1, 0, 1);
...
INSERT INTO `perl_event_export_settings` VALUES (81, 'EVENT_SPAWN_ZONE', 0, 0, 0, 0, 1);
INSERT INTO `perl_event_export_settings` VALUES (82, 'EVENT_DEATH_ZONE', 0, 0, 0, 0, 1);
INSERT INTO `perl_event_export_settings` VALUES (83, 'EVENT_USE_SKILL', 0, 0, 0, 0, 1);
